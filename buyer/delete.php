...
$sql = "SELECT * FROM `add` WHERE id = $ids ORDER BY am_p_kg DESC";
...
?>
 ...
 <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <h4><i class="fas fa-table mr-1"></i> Delete Vegetables  </h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                 ...
                                 <?php while($array = $query->fetch_array()){
                                  ...
                                  $state = $array["state"];
                                    ...
                                    echo ' <td><a href="del_fuct.php?ps_id=' . $id . '" type="button" name="view" value="View" class="btn btn-danger">Delete</a> </td>';
