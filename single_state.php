...
$single_state_n = $_GET["single_state_n"];
...
$sql = "SELECT * FROM `add` WHERE state = '$single_state_n'";
...
?>
 ...
 <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <h4>Available Vegetables in <i class="fas fa-table mr-1"></i><?php echo ucwords($single_state_n); ?>  </h4>
                            </div>
